BT.Views.TrackShow = Backbone.CompositeView.extend({
	...
	graphPredProg: function (event) {
		...
		$.ajax({
			type: "GET",
			url: "https://beat-tree.herokuapp.com/api/neojson?query_type=predandprog&node_id=" + that.model.get('track_spotify_id')
	...
	graphOrigins: function (event) {
		...
		$.ajax({
			type: "GET",
			url: "https://beat-tree.herokuapp.com/api/neojson?query_type=origins&node_id=" + that.model.get('track_spotify_id')
		}).done( function (jsonResp) {
	...
	graphInspirations: function (event) {
		...
		$.ajax({
			type: "GET",
			url: "https://beat-tree.herokuapp.com/api/neojson?query_type=inspirations&node_id=" + that.model.get('track_spotify_id')
		}).done( function (jsonResp) {
	...
	graphSubgraph: function (event) {
		...
		$.ajax({
			type: "GET",
			url: "https://beat-tree.herokuapp.com/api/neojson?query_type=subgraph&node_id=" + that.model.get('track_spotify_id')
		}).done( function (jsonResp) {
